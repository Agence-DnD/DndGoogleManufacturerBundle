...
namespace Dnd\Google\Manufacturer\Component\ArrayConverter\StandardToFlat\Attribute;
...
use Dnd\Google\Manufacturer\Bundle\Exception\GoogleManufacturerException;
use Dnd\Google\Manufacturer\Component\Model\GoogleImportExport;
use Dnd\Google\Manufacturer\Component\Renderer\PublicFileRenderer;
use Dnd\Google\Manufacturer\Component\Validator\Constraints\FieldValidator;
 ...
 * Class Google
 *
 * @package   Dnd\Google\Manufacturer\Component\ArrayConverter\StandardToFlat\Attribute
...
class Google extends PimProductLocalized implements ArrayConverterInterface
{
     ...
     */
    const PATTERN_ATTRIBUTE_KEY_EXTRACTOR = '/^(?P<attribute_key>%s)((?P<with_locale>\-[a-z]{2}\_[A-Z]{2})(?P<with_scope>\-.*)?)?/i';
    /**
